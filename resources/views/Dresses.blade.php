                            ...
                            <ul class="navbar-nav ml-auto mt-2 mt-lg-0 mr-3">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="menu-1">
                                        ...
                                        <li><a class="dropdown-item" href="index-6.html">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                    <div class="page-caption">
                        <h1 class="page-title">Supplier Dresses</h1>
                    </div>
                </div>
                <!-- /.page caption -->
            </div>
                ...
                <div class="row">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-white" aria-current="page">Supplier Dresses List</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vendor-thumbnail">
                        ...
                        <div class="vendor-img">
                            <!-- Vendor img -->
                            <a href="#"><img src="images/supplier-dress-2.jpg" alt="" class="img-fluid"></a>
                            <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                        </div>
                        <!-- /.Vendor img -->
                        <div class="vendor-content">
                            <!-- Vendor Content -->
                            <h2 class="vendor-title"><a href="#" class="title">Monika Wedding Dresses</a></h2>
                            <p class="vendor-address">Baroda, Gujarat.</p>
                        </div>
                        <!-- /.Vendor Content -->
                        <div class="vendor-meta">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vendor-thumbnail">
                        ...
                        <div class="vendor-img">
                            <!-- Vendor img -->
                            <a href="#"><img src="images/supplier-dress-3.jpg" alt="" class="img-fluid"></a>
                            <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                        </div>
                        <!-- /.Vendor img -->
                        <div class="vendor-content">
                            <!-- Vendor Content -->
                            <h2 class="vendor-title"><a href="#" class="title">Anamika Dresses</a></h2>
                            <p class="vendor-address">Baroda, Gujarat.</p>
                        </div>
                        <!-- /.Vendor Content -->
                        <div class="vendor-meta">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vendor-thumbnail">
                        ...
                        <div class="vendor-img">
                            <!-- Vendor img -->
                            <a href="#"><img src="images/supplier-dress-4.jpg" alt="" class="img-fluid"></a>
                            <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                        </div>
                        <!-- /.Vendor img -->
                        <div class="vendor-content">
                            <!-- Vendor Content -->
                            <h2 class="vendor-title"><a href="#" class="title">Sarika Dresses</a></h2>
                            <p class="vendor-address">Baroda, Gujarat.</p>
                        </div>
                        <!-- /.Vendor Content -->
                        <div class="vendor-meta">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vendor-thumbnail">
                        ...
                        <div class="vendor-img">
                            <!-- Vendor img -->
                            <a href="#"><img src="images/supplier-dress-5.jpg" alt="" class="img-fluid"></a>
                            <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                        </div>
                        <!-- /.Vendor img -->
                        <div class="vendor-content">
                            <!-- Vendor Content -->
                            <h2 class="vendor-title"><a href="#" class="title">Pamela Wedding Dresses</a></h2>
                            <p class="vendor-address">Baroda, Gujarat.</p>
                        </div>
                        <!-- /.Vendor Content -->
                        <div class="vendor-meta">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vendor-thumbnail">
                        ...
                        <div class="vendor-img">
                            <!-- Vendor img -->
                            <a href="#"><img src="images/supplier-dress-6.jpg" alt="" class="img-fluid"></a>
                            <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                        </div>
                        <!-- /.Vendor img -->
                        <div class="vendor-content">
                            <!-- Vendor Content -->
                            <h2 class="vendor-title"><a href="#" class="title">Howard Bride Dresses</a></h2>
                            <p class="vendor-address">Baroda, Gujarat.</p>
                        </div>
                        <!-- /.Vendor Content -->
                        <div class="vendor-meta">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vendor-thumbnail">
                        ...
                        <div class="vendor-img">
                            <!-- Vendor img -->
                            <a href="#"><img src="images/supplier-6.jpg" alt="" class="img-fluid"></a>
                            <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                        </div>
                        <!-- /.Vendor img -->
                        <div class="vendor-content">
                            <!-- Vendor Content -->
                            <h2 class="vendor-title"><a href="#" class="title">Kimberly Bridal Wedding Dresses</a></h2>
                            <p class="vendor-address">Baroda, Gujarat.</p>
                        </div>
                        <!-- /.Vendor Content -->
                        <div class="vendor-meta">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vendor-thumbnail">
                        ...
                        <div class="vendor-img">
                            <!-- Vendor img -->
                            <a href="#"><img src="images/supplier-dress-7.jpg" alt="" class="img-fluid"></a>
                            <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                        </div>
                        <!-- /.Vendor img -->
                        <div class="vendor-content">
                            <!-- Vendor Content -->
                            <h2 class="vendor-title"><a href="#" class="title">Josephine Wedding Dresses</a></h2>
                            <p class="vendor-address">Baroda, Gujarat.</p>
                        </div>
                        <!-- /.Vendor Content -->
                        <div class="vendor-meta">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="vendor-thumbnail">
                        ...
                        <div class="vendor-img">
                            <!-- Vendor img -->
                            <a href="#"><img src="images/supplier-dress-8.jpg" alt="" class="img-fluid"></a>
                            <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                        </div>
                        <!-- /.Vendor img -->
                        <div class="vendor-content">
                            <!-- Vendor Content -->
                            <h2 class="vendor-title"><a href="#" class="title">Derrick Bridal Dresses</a></h2>
                            <p class="vendor-address">Baroda, Gujarat.</p>
                        </div>
                        <!-- /.Vendor Content -->
                        <div class="vendor-meta">
