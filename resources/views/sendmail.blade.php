...
<body>
    <div style="background: #333; height: 0px;"></div>
                        ...
                        <tr>
                            <td class="wrapper">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <!--<a href="/" class="template-logo"><img src="images/logo.png" alt=""></a>-->
                                            <p class="lead text-secondary">{{ $details['title'] }}
                                            </p>
                                                        ...
                                                        <td align="center" class="mt30 mb30">
                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p class="user-text">Username: <span>{{ $details['username'] }}</span>
                                                                                <br> Email ID: <span>{{ $details['email'] }}</span>
                                                                                <br> OTP : <span class="text-secondary">{{ $details['OTP'] }}</span>
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                            ...
                                            <p class="lead mb0">Kindly put his OTP number to reset your forget password. </p>
                                            <p>Thank you</p>
                                            <p class="mb0">If you have any problems, please contact us at <a href="#" class="click-link">ashirafzal96@gamil.com</a> </p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td class="wrapper">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <p>You received this email beacuse you have just tell us that you forgot your real wed account password.
                                             If it look weird
